    ...
    public partial class Form4 : Form
    {
        ...
        private void ActualizarDataGridView()
        {
            try
            {
                ...
                dgvPantalones.DataSource = productos;
        ...
        private void tstEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dgvPantalones.CurrentRow == null)
                {
        ...
        private void dgvPantalones_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
